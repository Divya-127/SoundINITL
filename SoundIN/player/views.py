...
def categories(request, uid = -1):
	...
	url = "https://api.openweathermap.org/data/2.5/weather?q=Mumbai&appid=efa8d09033b1c4903c3bcf0b10ad24ae"
...
def playlistPage(request, playlist, uid):
	...
	if playlist == 'Work Music':
		...
		data = (requests.get(
			"https://api.unsplash.com/photos/a7e71c0jSgQ?client_id=btiCQcHkbunjS7pIGbyncLUAaXM9xFgxW8gML2k8Qto")).json()
		url = data['urls']
		img_url = (url['raw'])
	...
	if playlist == 'Focus PLaylist 1':
		...
		data = (requests.get(
			"https://api.unsplash.com/photos/1ABHVB3_JL4?client_id=btiCQcHkbunjS7pIGbyncLUAaXM9xFgxW8gML2k8Qto")).json()
		url = data['urls']
		img_url = (url['raw'])
	...
	if playlist == 'Mood playlists 1':
		...
		data = (requests.get(
			"https://api.unsplash.com/photos/xbvKO2Df8M4?client_id=btiCQcHkbunjS7pIGbyncLUAaXM9xFgxW8gML2k8Qto")).json()
		url = data['urls']
		img_url = (url['raw'])
	...
	if playlist == 'Mood playlists 2':
		...
		spotify = spotipy.Spotify(client_credentials_manager=SpotifyClientCredentials(client_id='26252aded60646f1a4241dbe33c60e9f',
																client_secret='56dbc2d4765941c0b553f1ea3fc3b9f2'))
		data = (requests.get(
			"https://api.unsplash.com/photos/TzVN0xQhWaQ?client_id=btiCQcHkbunjS7pIGbyncLUAaXM9xFgxW8gML2k8Qto")).json()
		url = data['urls']
		img_url = (url['raw'])
	...
	if playlist == 'Home PLaylist 1':
		print("here")
		uri = 'spotify:artist:4yznag7I8GkHBsrFrxdxvT'
		spotify = spotipy.Spotify(client_credentials_manager=SpotifyClientCredentials(client_id='26252aded60646f1a4241dbe33c60e9f',
																client_secret='56dbc2d4765941c0b553f1ea3fc3b9f2'))
		data = (requests.get(
			"https://api.unsplash.com/photos/OtXADkUh3-I?client_id=btiCQcHkbunjS7pIGbyncLUAaXM9xFgxW8gML2k8Qto")).json()
		url = data['urls']
		img_url = (url['raw'])
	...
	if playlist== 'Home PLaylist 2':
		uri = 'spotify:artist:3wCYobOehmk6hFQaIJZUJv'
		spotify = spotipy.Spotify(client_credentials_manager=SpotifyClientCredentials(client_id='26252aded60646f1a4241dbe33c60e9f',
																client_secret='56dbc2d4765941c0b553f1ea3fc3b9f2'))
		data = (requests.get(
			"https://api.unsplash.com/photos/BlIhVfXbi9s?client_id=btiCQcHkbunjS7pIGbyncLUAaXM9xFgxW8gML2k8Qto")).json()
		url = data['urls']
		img_url = (url['raw'])
		results = spotify.artist_top_tracks(uri)
		fresults = results['tracks'][:10]

	if playlist== 'Home PLaylist 3':
		uri = 'spotify: artist:7HQUzNqaFcbReC7qiuVUC0'
		spotify = spotipy.Spotify(client_credentials_manager=SpotifyClientCredentials(client_id='26252aded60646f1a4241dbe33c60e9f',
																client_secret='56dbc2d4765941c0b553f1ea3fc3b9f2'))
		data = (requests.get(
			"https://api.unsplash.com/photos/UV81E0oXXWQ?client_id=btiCQcHkbunjS7pIGbyncLUAaXM9xFgxW8gML2k8Qto")).json()
		url = data['urls']
		img_url = (url['raw'])
		results = spotify.artist_top_tracks(uri)
		fresults = results['tracks'][:10]
	...
	if playlist== 'Sunday playlists 1':
		...
		spotify = spotipy.Spotify(client_credentials_manager=SpotifyClientCredentials(client_id='26252aded60646f1a4241dbe33c60e9f',
																client_secret='56dbc2d4765941c0b553f1ea3fc3b9f2'))
		data = (requests.get(
			"https://api.unsplash.com/photos/t973uuEKvck?client_id=btiCQcHkbunjS7pIGbyncLUAaXM9xFgxW8gML2k8Qto")).json()
		url = data['urls']
		img_url = (url['raw'])
	...
	if playlist == 'Your Talent Playlist':
		...
		data2 = (requests.get(
			"https://api.unsplash.com/photos/QTx_TbHmWDs?client_id=btiCQcHkbunjS7pIGbyncLUAaXM9xFgxW8gML2k8Qto")).json()
		url = data2['urls']
		img_url = (url['raw'])
	...
	try:
		...
		user = {'user_id': -1, 'name': 'Anonymous'}
	return render(request, 'playlists.html', {'user':user,'results':fresults,'playlist':playlist, 'uid':uid,'url':img_url})
...
def login(request):
	...
	data = (requests.get("https://api.unsplash.com/photos/fCEJGBzAkrU?client_id=btiCQcHkbunjS7pIGbyncLUAaXM9xFgxW8gML2k8Qto")).json()
	url = data['urls']
	img_url = (url['raw'])
	...
	if request.method == 'POST':
		...
		if id > 0:
			...
			return redirect('/')	
	return render(request, 'login.html',{'url':img_url})
